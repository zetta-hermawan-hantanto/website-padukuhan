  ...
  return (
    <section className="flex flex-col sm:mx-32 mx-4 relative left-0 right-0 items-center">
      <ContainerSectionProfile
        ...
        alt="Padukuhan Bolang terletak di Kalurahan Giripanggung, Kapanewon Tepus, Kabupaten Gunung Kidul, Daerah Istimewa Yogyakarta."
      />
      ...
      <ContainerSectionProfile
        ...
        alt="Geografi dari Padukuhan Bolang."
      />
      ...
      <ContainerSectionProfile
        ...
        alt="Perangkat dusun dari Padukuhan Bolang sedang melakukan rapat bersama warga."
      />
      ...
      <ContainerSectionProfile
        ...
        image="/assets/images/petani-keladang.jpeg"
        alt="Petani Bolang sedang menuju ke ladang untuk mengambil pakan ternak."
      />
      ...
      <ContainerSectionProfile
        ...
        alt="SMK YPKK merupakan salah satu sekolah tingkat menengah atas yang letaknya cukup dekat dengan Padukuhan Bolang."
      />
      ...
      <ContainerSectionProfile
        ...
        alt="Suasana alam dari Padukuhan Bolang yakni hutan."
      />
    </section>
  );
};
